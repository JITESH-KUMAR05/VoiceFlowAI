      ...
      <div className="container mx-auto px-6 pb-12">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Test the B2B Sales AI agent via phone call or browser session. Configure language, voice, and model settings.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <AgentInfoCard
              ...
              purpose="Qualify B2B leads for startups and MSMEs through intelligent conversation"
          ...
          >
            <div className="p-6 rounded-2xl bg-card/50 border border-border backdrop-blur-sm">
              ...
              {/* Form */}
              <TestForm agentType="b2b" testMode={testMode} />
            </div>
          </motion.div>
        </div>
      </div>
