...
export default function RealEstateUserDetail() {
  ...
  if (!user) return <AgentLayout agentType="real-estate"><div className="container mx-auto px-6 py-12"><div className="glass-card p-12 text-center"><p className="text-muted-foreground">User not found.</p><Link to="/real-estate/crm/users"><Button variant="ghost" className="mt-4">Back</Button></Link></div></div></AgentLayout>;
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="lg:col-span-1">
            <div className="glass-card p-6 sticky top-28">
              ...
              <div className="mt-6"><Link to="/real-estate/live-call"><Button variant="gradient-secondary" className="w-full">Start New Call</Button></Link></div>
            </div>
          </motion.div>
